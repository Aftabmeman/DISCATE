...
const aboutTranslations: Record<string, any> = {
  ...
  "Hindi": {
    ...
    motive: {
      head: "हमारा उद्देश्य",
      body: "हमारा मानना है कि क्षमता सार्वभौमिक है लेकिन अवसर नहीं। हमारा उद्देश्य आधुनिक विद्वानों को किसी bhi विषय को हल करने के आत्मविश्वास के साथ सशक्त बनाना है, चाहे उनकी पृष्ठभूमि या क्षेत्रीय भाषा कुछ भी हो। हम बौद्धिक जिज्ञासा की चिंगारी को जगाने aur शैक्षणिक प्रदर्शन के शिखर तक पहुँचने के लिए आवश्यक तकनीकी सीढ़ी प्रदान करने के लिए मौजूद हैं।"
    }
  }
};
