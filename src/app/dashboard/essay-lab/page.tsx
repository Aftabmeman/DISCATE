...
export default function WritingWizardPage() {
  ...
  return (
    <div className="flex flex-col h-full space-y-12 pb-40 animate-in fade-in duration-700 px-4 max-w-2xl mx-auto">
      ...
      <div className="flex-1">
        {step === 1 && (
          <Card className="border-none shadow-3xl rounded-[3rem] bg-white dark:bg-slate-900 overflow-hidden animate-in slide-in-from-bottom-8 duration-700">
            <CardHeader className="p-10 sm:p-16 pb-8 text-center">
            ...
            <CardContent className="p-10 sm:p-16 pt-0 space-y-10 text-center">
              <textarea 
        ...
        {step === 2 && (
          <Card className="border-none shadow-3xl rounded-[3rem] bg-white dark:bg-slate-900 overflow-hidden animate-in slide-in-from-bottom-8 duration-700">
            ...
            <CardContent className="p-10 sm:p-16 pt-0 space-y-12">
        ...
        {step === 3 && (
          <div className="space-y-10 animate-in fade-in slide-in-from-right-12 duration-1000">
            <Card className="border-none shadow-3xl rounded-[3rem] bg-white dark:bg-slate-900 overflow-hidden border border-slate-100 dark:border-white/5">
              <CardHeader className="p-10 sm:p-14 pb-8 flex flex-row items-center justify-between border-b border-slate-50 dark:border-white/5">
              ...
              <CardContent className="p-10 sm:p-14 pt-12 space-y-12">
                ...
                <textarea 
                  className="w-full min-h-[500px] rounded-[3.5rem] bg-slate-50 dark:bg-slate-950 border-none p-12 sm:p-16 text-xl sm:text-2xl font-medium dark:text-white resize-none leading-relaxed transition-all outline-none shadow-inner placeholder:text-slate-100 dark:placeholder:text-slate-800"
        ...
        {step === 5 && result && (
          <div className="space-y-12 pb-20 animate-in zoom-in-95 duration-1000">
            ...
            <div className="text-center space-y-8 mb-12">
               ...
               <div className="relative h-64 w-64 flex items-center justify-center mx-auto">
                  ...
                  <div className="absolute inset-0 flex flex-col items-center justify-center">
                    <span className="text-7xl font-black text-slate-900 dark:text-white">{result.evaluationData.overallScore}%</span>
            ...
            {/* SCHOLAR REWARD BOX */}
            <div className="bg-slate-900 p-10 rounded-[3rem] border border-amber-500/20 flex items-center justify-between shadow-2xl relative overflow-hidden group">
              <div className="absolute top-0 right-0 w-32 h-32 bg-amber-500/10 rounded-full blur-3xl -mr-10 -mt-10" />
              <div className="space-y-2 relative z-10 text-left">
                <p className="text-[11px] font-black text-amber-500 uppercase tracking-[0.4em]">Scholar Reward</p>
                <h3 className="text-6xl font-black text-amber-400">+{result.evaluationData.coinsEarned}</h3>
              </div>
              <div className="h-24 w-24 rounded-[2rem] bg-amber-500/10 flex items-center justify-center border border-amber-500/20 relative z-10 shadow-inner">
            ...
            <div className="grid grid-cols-1 gap-6">
              {[
                ...
                <div key={i} className="bg-white dark:bg-slate-900/60 p-10 rounded-[2.5rem] border border-slate-100 dark:border-white/5 space-y-6 shadow-sm">
                  <div className="flex justify-between items-center">
                     <div className="flex items-center gap-4">
                        <stat.icon className="h-6 w-6 text-primary" />
                        <span className="text-[11px] font-black uppercase tracking-[0.3em] text-slate-400">{stat.label}</span>
                     </div>
                     <span className="text-3xl font-black text-slate-900 dark:text-white">{stat.val}%</span>
                  </div>
                  <Progress value={stat.val} className="h-4 rounded-full bg-slate-100 dark:bg-slate-800" />
                </div>
              ))}
            </div>

            {/* PROFESSOR REMARK */}
            <div className="p-10 bg-primary/5 dark:bg-primary/10 rounded-[3rem] italic text-2xl sm:text-3xl text-slate-700 dark:text-slate-100 leading-relaxed border-l-[16px] border-primary shadow-inner text-balance">
            ...
            <div className="space-y-8">
              ...
              <div className="p-10 bg-slate-900 dark:bg-black rounded-[3.5rem] text-slate-300 leading-relaxed text-xl sm:text-2xl italic whitespace-pre-wrap border border-white/5 shadow-[0_20px_60px_rgba(0,0,0,0.4)] text-left">
