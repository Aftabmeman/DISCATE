            ...
            <div className="text-center space-y-4 mb-8">
               ...
               <div className="relative h-40 w-40 sm:h-56 sm:w-56 flex items-center justify-center mx-auto">
                  <svg className="h-full w-full rotate-[-90deg]" viewBox="0 0 192 192">
                    ...
                    <circle cx="96" cy="96" r="86" fill="transparent" stroke="currentColor" strokeWidth="16" strokeDasharray="540.35" strokeDashoffset={540.35 - (540.35 * (result?.evaluationData?.overallScore || 0)) / 100} strokeLinecap="round" className="text-primary transition-all duration-[2.5s] ease-out shadow-[0_0_20px_rgba(147,51,234,0.3)]" />
                  </svg>
